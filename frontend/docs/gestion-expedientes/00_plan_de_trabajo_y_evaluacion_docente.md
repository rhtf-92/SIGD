...
- **Sub-equipo Asignado (M3):**
  - **Líder de Sub-equipo:** `Isack (Isak) Vargas` (Git: `isack-vargas` / `isakvargas`)
...
Matriz de entregables para la calificación del sub-equipo del Módulo 3 (28 Story Points):
...
1. DATOS DEL ESTUDIANTE Y ENTREGABLES
   ...
   - Rol en Sub-equipo: [ ] Líder de Sub-equipo (Isack Vargas)   [ ] Soporte Arquitectura (Christiam Saúl)
