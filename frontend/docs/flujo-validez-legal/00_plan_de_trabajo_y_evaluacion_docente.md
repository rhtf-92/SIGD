...
- **Sub-equipo Asignado (M04 / Grupo 5):**
  - **Líder de Sub-equipo:** `Adriano David Espinoza Ramírez` (Git: `ADERRTX` / Rama: `F_ADRIANO`)
...
1. DATOS DEL ESTUDIANTE Y ENTREGABLES
   ...
   - Rol en Sub-equipo: [ ] Líder / Workflow / Refirma (Adriano David Espinoza Ramírez)
                        [ ] Proyector RD (Isaí)   [ ] UI/UX / CVD / Validador (Mayra)
