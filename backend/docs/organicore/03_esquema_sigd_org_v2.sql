...
BEGIN
    ...
    ELSE
        IF NEW.parent_id = NEW.id THEN
            RAISE EXCEPTION 'Un ├írea no puede ser su propio padre';
        END IF;
        ...
        IF EXISTS (
            ...
            RAISE EXCEPTION 'La reasignaci├│n crea un ciclo jer├írquico';
        END IF;
        ...
        IF parent_path IS NULL THEN
            RAISE EXCEPTION 'El ├írea padre no existe: %', NEW.parent_id;
        END IF;
