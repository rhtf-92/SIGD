# B_PANAIFO - Validación OrganiCore v2
...
La validación ejecutable está en `05_validacion_organicore_v2.sql` y debe ejecutarse después de `03_esquema_sigd_org_v2.sql`.
...
- Existen las restricciones de exclusión GiST para evitar solapamientos.
