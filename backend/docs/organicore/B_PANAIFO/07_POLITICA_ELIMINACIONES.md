...
Las encargaturas no se eliminan físicamente. Para finalizar una encargatura se actualiza el límite superior de `vigencia`, conservando el registro y su evidencia.
