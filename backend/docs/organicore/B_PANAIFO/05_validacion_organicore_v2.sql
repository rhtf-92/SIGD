-- B_PANAIFO - Validación ejecutable OrganiCore v2
-- Ejecutar después de 03_esquema_sigd_org_v2.sql con ON_ERROR_STOP=1
...
BEGIN
    ...
    IF exclusion_count <> 2 THEN
        RAISE EXCEPTION 'Deben existir las dos restricciones de exclusión GiST';
    END IF;
END;
$$;
