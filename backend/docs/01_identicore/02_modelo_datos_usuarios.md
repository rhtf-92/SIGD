...
> **OBSOLETO / LEGACY v1 — NO USAR PARA v2.** Fuente de verdad v2: `02_modelo_datos_identicore_v2.md` + `02_diccionario_datos_identicore_v2.md` + `03_esquema_sigd_auth_v2.sql`. Se conserva como antecedente.
